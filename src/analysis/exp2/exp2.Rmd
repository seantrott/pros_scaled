...
```{r}
# setwd("/Users/seantrott/Dropbox/UCSD/Research/IndirectSpeechActs/Prosody/pros_scaled/src/analysis/exp2/")
df_critical = read.csv("../../../data/processed/exp2/exp2.csv")
...
```{r}
df_audio = read_csv("../../../data/processed/exp1/audio_features_original_stimuli.csv")
